...
df4=FirstEnd(data,FirstEnd_list)

df4=df4.reset_index(drop=True)

with open('../data/TestB_data_self_part1_4_FirstEnd.pickle','wb') as output:
    pickle.dump(df4,output)
    
print ('Member_features_self_part1_4 Time:',(time.time()-start)/60.0)