...
df2=Unique(data,Unique_list)

df2=df2.reset_index(drop=True)

with open('../data/TestB_data_self_part1_1_Unique.pickle','wb') as output:
    pickle.dump(df2,output)
    
print ('Member_features_self_part1_1 Time:',(time.time()-start)/60.0)
